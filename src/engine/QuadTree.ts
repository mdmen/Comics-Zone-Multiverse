...
export class QuadTree {
  ...
  private split(): void {
    ...
    this.nodes[0] = new QuadTree(
      new Rectangle(position.x, position.y, halfWidth, halfHeight),
      level
    );

    this.nodes[1] = new QuadTree(
      new Rectangle(position.x + halfWidth, position.y, halfWidth, halfHeight),
      level
    );
    ...
    this.nodes[3] = new QuadTree(
      new Rectangle(position.x, position.y + halfHeight, halfWidth, halfHeight),
      level
    );
  }
