...
export class Text extends Picture {
  ...
  constructor({
    ...
    super({ skipImageCreation: true, image, ...options });
  ...
  async setText(text: string) {
    ...
    const scaled = await getScaledImageSource(canvas, this.scale);
    this.image = await createImage(scaled);
